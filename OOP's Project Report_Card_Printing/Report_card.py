...
class Exam(object):
    ...
    def portal(self):
        ...
        print(" ")
        print(" " * 30, "Welcome")
        print(" " * 20, "Thapar University Portal")
        print(" ")
        print("=" * 80)
        ...
        if choice == 1:
            print("Register Yourself On Thapar Portal")
            print("="*30)
    ...
    def getdata(self):
        ...
        print("2 = Computer Science Engg")
        print("3 = Mechanical Engg")
        print("4 = Civil Engg")
        print("5 = Architecture Dept")
    ...
    def CSE(self):
        ...
        print("3=Second Semester")
        print("4=Second Semester")
        print("5=Second Semester")
        print("6=Second Semester")
        print("7=Second Semester")
        print("8=Second Semester")
        print("=" * 30)
        choice=int(input("Enter Your Choice="))
    ...
    def calculate_marks(self):
        try:
            ...
            while self.i <= self.sub:
                ...
                self.random=self.mydict
            self.obtain = sum(self.mydict.values())
            self.subject=self.sub*100
...
class Assesment(Exam,Calculate):
    def __init__(self):
        ...
        for m,n in self.random.items():
            self.length=int(len(m))
            print(m," "*(30-self.length),"100"," "*20,n)
            print(" ")
        print("─"*80)
        for j, l in self.random.items():
            if l <= 33:
                print("Failed in ", j)
        for n in self.random.values():
            if n>33:
                self.result = "pass"
            else:
                self.result = "Fail"
                break
        print("Total:",self.subject," "*15,"Result:",self.result)
